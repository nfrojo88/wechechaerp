    ...
    public function down(): void
    {
        if (Schema::hasTable('credit_store_payments')) {
            Schema::table('credit_store_payments', function (Blueprint $table) {
                ...
                foreach ($cols as $c) {
                    if (Schema::hasColumn('credit_store_payments', $c)) {
                        $table->dropColumn($c);
                    }
                }
            });
