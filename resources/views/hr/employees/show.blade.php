...
@if($empPettyCash->isNotEmpty())
    <!-- Assigned Petty Cash Balance Card (Only for Petty Cash) -->
        ...
        <div class="card-body p-4 text-white">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-circle bg-white bg-opacity-20 p-3 d-flex align-items-center justify-content-center shadow-sm" style="width: 58px; height: 58px;">
                    ...
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-white font-monospace">ETB {{ number_format($empPettyCashBal, 2) }}</h2>
                        <div class="text-white small mt-1 opacity-90">
                            <i class="fa-solid fa-circle-check text-warning me-1"></i> Available Petty Cash Balance allocated to this employee
                        </div>
                    </div>
                </div>
