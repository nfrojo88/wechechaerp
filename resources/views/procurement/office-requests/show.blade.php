            ...
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body p-4">
                    <div style="background:#d1fae5; border:1px solid #34d399; border-radius:8px; padding:10px 14px; margin-bottom:14px; font-size:0.88rem; color:#065f46; line-height:1.5;">
                        ...
                        After confirming, <strong>{{ $office_request->pr_no }}</strong> will be marked as <strong>issued from store</strong> and automatically forwarded to <strong>Finance Head</strong> for expense recording &amp; payment tracking. A Finance expense entry will be created automatically.
                    </div>
                    <div class="mb-0">
